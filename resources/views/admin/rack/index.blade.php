                ...
                <div class="modal-body">
                    <form id="company-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" id="valid-category_id">{{ $errors->first('category_id') }}</div>
                        </div>
                        <div class="form-group">
                            <label for="position">Posisi <sup class="text-danger">*</sup></label>
                            <input type="text" class="form-control" id="position" name="position"
                                placeholder="Masukkan Posisi..." autocomplete="off">
                            <div class="invalid-position" id="valid-position"></div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-save').click(function() {
                ...
                var type = "POST";
                var ajaxurl = '{{ route('admin.rack.store') }}';
                ...
                if (state == "update") {
                    ...
                    var id = $('#id').val();
                    type = "PUT";
                    ajaxurl = '{{ route('admin.rack.store') }}' + '/' + id;
                }
            ...
            $('body').on('click', '#btn-edit', function() {
                ...
                $.get('{{ route('admin.rack.index') }}' + '/' + id + '/edit', function(data) {
                    $('#company-form').find('.form-control').removeClass('is-invalid is-valid');
                    $('#id').val(data.id);
