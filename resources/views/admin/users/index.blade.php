            ...
            <div class="modal-body">
                <form id="company-form">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 form-control form-control-sm @error('role_id') is-invalid @enderror" name="role_id" id="role_id">
                            <option value="" selected disabled>-- Pilih Hak Akses --</option>
                                @foreach ($role as $data)
                                    <option value="{{ $data->id }}" {{ old('role_id') == $data->id ? 'selected' : '' }}>{{ $data->name }}</option>
                                @endforeach
                        </select>
                        <div class="invalid-feedback" id="valid-category">{{ $errors->first('role_id') }}</div>
                    </div>
                    <div class="form-group">
